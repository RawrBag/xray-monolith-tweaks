...
void CSoundRender_Environment::clamp()
{
	...
	//::clamp(Room, (float)AL_REVERB_MIN_GAIN, (float)AL_REVERB_MAX_GAIN);
	//::clamp(RoomHF, (float)AL_REVERB_MIN_GAINHF, (float)AL_REVERB_MAX_GAINHF);
	//::clamp(RoomLF, (float)AL_REVERB_MIN_GAINLF, (float)AL_REVERB_MAX_GAINLF);
	...
	//::clamp(DecayLFRatio, AL_REVERB_MIN_DECAY_LFRATIO, AL_REVERB_MAX_DECAY_LFRATIO);
	//::clamp(Reflections, (float)AL_REVERB_MIN_REFLECTIONS_GAIN, (float)AL_REVERB_MAX_REFLECTIONS_GAIN);
	//::clamp(ReflectionsDelay, AL_REVERB_MIN_REFLECTIONS_DELAY, (float)AL_REVERB_MAX_REFLECTIONS_DELAY);
	//::clamp(EchoTime, AL_REVERB_MIN_ECHO_TIME, AL_REVERB_MAX_ECHO_TIME);
	//::clamp(EchoDepth, AL_REVERB_MIN_ECHO_DEPTH, AL_REVERB_MAX_ECHO_DEPTH);
	//::clamp(Reverb, (float)AL_REVERB_MIN_LATE_REVERB_GAIN, (float)AL_REVERB_MAX_LATE_REVERB_GAIN);
	//::clamp(ReverbDelay, AL_REVERB_MIN_LATE_REVERB_DELAY, AL_REVERB_MAX_LATE_REVERB_DELAY);
	//::clamp(EnvironmentDiffusion, AL_REVERB_MIN_DIFFUSION, AL_REVERB_MAX_DIFFUSION);
	//::clamp(AirAbsorptionHF, AL_REVERB_MIN_AIR_ABSORPTION_GAINHF, AL_REVERB_MAX_AIR_ABSORPTION_GAINHF);
	//::clamp(ModulationTime, AL_REVERB_MIN_MODULATION_TIME, AL_REVERB_MAX_MODULATION_TIME);
	//::clamp(ModulationDepth, AL_REVERB_MIN_MODULATION_DEPTH, AL_REVERB_MAX_MODULATION_DEPTH);
	//::clamp(Density, AL_REVERB_MIN_DENSITY, AL_REVERB_MAX_DENSITY);
	//::clamp(HFReference, AL_REVERB_MIN_HFREFERENCE, AL_REVERB_MAX_HFREFERENCE);
	//::clamp(LFReference, AL_REVERB_MIN_LFREFERENCE, AL_REVERB_MAX_LFREFERENCE);
	//::clamp(DecayHFLimit, AL_REVERB_MIN_DECAY_HFLIMIT, AL_REVERB_MAX_DECAY_HFLIMIT);
}
